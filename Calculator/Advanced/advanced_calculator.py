...
class Calc():
    ...
    # Clear entry (C): deletes the last-entered value
    ...
    # Clear (CE): resets the calculator
    def All_Clear_Entry(self):
        self.Clear_Entry()
        self.total = 0

    # PI: enters the value of PI
    def pi(self):
        self.result = False
        self.current = math.pi
        self.display(self.current)

    # tau: enters the value of tau (2pi)
    def tau(self):
        self.result = False
        self.current = math.tau
        self.display(self.current)

    # e: enters the value of e (Euler's number, the base of the natural logarithm, approximately 2.718)
    def e(self):
        self.result = False
        self.current = math.e
        self.display(self.current)
    ...
    def squared(self):
        ...
        try:
            ...
            # show error popup, telling user to enter a valid operation
            tkinter.messagebox.showerror("Error", "Please enter a valid operation")
        # self.current = math.sqrt(float(txtDisplay.get()))
        self.display(self.current)
    ...
    # exp: raises e to the power of the number entered (e^x)
    def exp(self):
        self.result = False
